...
package com.coz.calabozopixeladodominicano.android;
...
/*
			...
			SPDSettings.set(instance.getPreferences("CalabozoPixeladoDominicano"));
		...
		initialize(new CalabozoPixeladoDominicano(support), config);
