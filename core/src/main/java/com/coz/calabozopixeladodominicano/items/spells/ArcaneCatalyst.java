...
import com.coz.calabozopixeladodominicano.items.scrolls.ScrollOfTerror;
...
public class ArcaneCatalyst extends Spell {
	...
	public static class Recipe extends com.coz.calabozopixeladodominicano.items.Recipe {
