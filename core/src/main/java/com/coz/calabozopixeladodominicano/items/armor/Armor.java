...
import com.coz.calabozopixeladodominicano.items.armor.curses.AntiEntropy;
import com.coz.calabozopixeladodominicano.items.armor.curses.Bulk;
import com.coz.calabozopixeladodominicano.items.armor.curses.Corrosion;
import com.coz.calabozopixeladodominicano.items.armor.curses.Displacement;
import com.coz.calabozopixeladodominicano.items.armor.curses.Metabolism;
import com.coz.calabozopixeladodominicano.items.armor.curses.Multiplicity;
import com.coz.calabozopixeladodominicano.items.armor.curses.Overgrowth;
import com.coz.calabozopixeladodominicano.items.armor.curses.Stench;
import com.coz.calabozopixeladodominicano.items.armor.glyphs.Affection;
...
import com.coz.calabozopixeladodominicano.items.armor.glyphs.Camouflage;
import com.coz.calabozopixeladodominicano.items.armor.glyphs.Entanglement;
import com.coz.calabozopixeladodominicano.items.armor.glyphs.Flow;
import com.coz.calabozopixeladodominicano.items.armor.glyphs.Obfuscation;
import com.coz.calabozopixeladodominicano.items.armor.glyphs.Potential;
import com.coz.calabozopixeladodominicano.items.armor.glyphs.Repulsion;
import com.coz.calabozopixeladodominicano.items.armor.glyphs.Stone;
import com.coz.calabozopixeladodominicano.items.armor.glyphs.Swiftness;
import com.coz.calabozopixeladodominicano.items.armor.glyphs.Thorns;
	...
	public Item upgrade( boolean inscribe ) {
		...
		if (inscribe){
			...
			if (hasCurseGlyph()){
				...
				if (Dungeon.hero != null && Dungeon.hero.heroClass.getType() != PlayerClassType.WARRIOR && Dungeon.hero.hasTalent(Talent.RUNIC_TRANSFERENCE)){
