...
import com.coz.calabozopixeladodominicano.sprites.EarthGuardianSprite;
import com.coz.calabozopixeladodominicano.sprites.GhostSprite;
import com.coz.calabozopixeladodominicano.sprites.RatSprite;
import com.coz.calabozopixeladodominicano.sprites.WardSprite;
...
public class SurfaceScene extends PixelScene {
	...
	private static class Avatar extends Image {
		...
		public Avatar( HeroClass cl ) {
			...
			frame( new TextureFilm( texture, WIDTH, HEIGHT ).get( cl.getAvatar() ) );
		}
	}
