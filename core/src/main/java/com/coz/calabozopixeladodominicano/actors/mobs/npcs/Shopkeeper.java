...
import com.coz.calabozopixeladodominicano.sprites.ShopkeeperSprite;
...
import com.coz.calabozopixeladodominicano.windows.WndTitledMessage;
		...
		switch (Dungeon.depth){
			case 6: default:
				return Messages.get(this, "talk_prison_intro") + "\n\n" + Messages.get(this,
						"talk_prison_" + Dungeon.hero.heroClass.getName());
			case 11:
