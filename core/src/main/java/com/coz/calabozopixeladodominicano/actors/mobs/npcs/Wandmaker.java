...
import com.coz.calabozopixeladodominicano.levels.rooms.special.MassGraveRoom;
import com.coz.calabozopixeladodominicano.levels.rooms.special.RotGardenRoom;
import com.coz.calabozopixeladodominicano.levels.rooms.standard.RitualSiteRoom;
...
import com.coz.calabozopixeladodominicano.sprites.WandmakerSprite;
import com.coz.calabozopixeladodominicano.windows.WndQuest;
import com.coz.calabozopixeladodominicano.windows.WndWandmaker;
...
public class Wandmaker extends NPC {
	...
	public boolean interact(Char c) {
		...
		if (Quest.given) {
			...
			String msg1 = "";
			String msg2 = "";
			switch(Dungeon.hero.heroClass.getName()){
				case "warrior":
