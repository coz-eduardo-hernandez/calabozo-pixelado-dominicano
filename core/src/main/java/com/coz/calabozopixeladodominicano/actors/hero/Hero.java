...
import com.coz.calabozopixeladodominicano.actors.blobs.SacrificialFire;
...
import com.coz.calabozopixeladodominicano.actors.buffs.AnkhInvulnerability;
...
import com.coz.calabozopixeladodominicano.actors.buffs.Combo;
import com.coz.calabozopixeladodominicano.actors.buffs.Drowsy;
import com.coz.calabozopixeladodominicano.actors.buffs.Foresight;
...
import com.coz.calabozopixeladodominicano.items.Heap.Type;
...
import com.coz.calabozopixeladodominicano.items.keys.Key;
...
import com.coz.calabozopixeladodominicano.journal.Notes;
...
import com.coz.calabozopixeladodominicano.mechanics.ShadowCaster;
import com.coz.calabozopixeladodominicano.messages.Messages;
import com.coz.calabozopixeladodominicano.scenes.AlchemyScene;
...
import com.coz.calabozopixeladodominicano.scenes.SurfaceScene;
...
import com.coz.calabozopixeladodominicano.windows.WndTradeItem;
...
public class Hero extends Char {
	...
	public HeroClass heroClass = null;//HeroClass.ROGUE;
...
*/
	...
	public int damageRoll() {
		...
		if (heroClass.getType() != PlayerClassType.DUELIST
	...
	public boolean canSelfTrample(){
		return canSelfTrample && !rooted && !flying &&
				...
				(heroClass.getType() != PlayerClassType.HUNTRESS && Dungeon.level.map[pos] == Terrain.FURROWED_GRASS) ||
				//standing on a plant
...
*/
	...
	public void onAttackComplete() {
		...
		if (hit && heroClass.getType() == PlayerClassType.DUELIST && wasEnemy){
			Buff.affect( this, Sai.ComboStrikeTracker.class).addHit();
		}
	...
	public boolean search( boolean intentional ) {
		...
		int distance = heroClass.getType() == PlayerClassType.ROGUE ? 2 : 1;
